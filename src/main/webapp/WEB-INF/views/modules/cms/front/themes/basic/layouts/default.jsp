...
<%-- 			    <li id="siteSwitch" class="dropdown">
	...
	<div class="container">
		...
		<div class="footer_nav">
			地址：北京市朝阳区双井百环家园18号楼19000室 &nbsp;&nbsp;&nbsp;&nbsp;邮编：10000 &nbsp;&nbsp;&nbsp;&nbsp;电话： +86-13718724915<br>
			 网站建设/网站设计支持：李小超
			</div>
		<%-- 	<div class="footer_nav"><a href="${ctx}/guestbook" target="_blank">公共留言学习</a> | <a href="${ctx}/search" target="_blank">全站搜索</a> | <a href="${ctx}/map-${site.id}${fns:getUrlSuffix()}" target="_blank">站点地图</a> | <a href="mailto:thinkgem@163.com">技术支持</a> | <a href="${pageContext.request.contextPath}${fns:getAdminPath()}" target="_blank">后台管理</a></div>
